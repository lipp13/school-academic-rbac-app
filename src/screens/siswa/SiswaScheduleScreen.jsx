...
export default function SiswaScheduleScreen({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      <HeaderBar
        ...
        subtitle={`Jadwal Tatap Muka Kelas ${className}`}
        showRole={true}
        showBack={true}
        ...
        ListHeaderComponent={
          <>
            ...
            <View style={styles.headerInfoRow}>
              <Text style={styles.headerInfoTitle}>Mata Pelajaran & Ruang Kelas</Text>
              <Text style={styles.headerInfoCount}>{schedules.length} jadwal</Text>
            </View>
          </>
        }
        ListEmptyComponent={
          !loading && (
            <View style={styles.emptyContainer}>
              ...
              <Text style={styles.emptyDesc}>Tidak ada kegiatan pembelajaran pada hari {selectedDay}.</Text>
            </View>
          )
        }
      />
...
const styles = StyleSheet.create({
  ...
  dayChipActive: {
    backgroundColor: COLORS.roles.siswa.primary,
    borderColor: COLORS.roles.siswa.primary,
  },
  dayChipText: {
    fontSize: 11,
